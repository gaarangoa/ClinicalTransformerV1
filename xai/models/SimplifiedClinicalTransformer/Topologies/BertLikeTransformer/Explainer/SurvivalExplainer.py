...
def survival_attention_scores(data, evaluator, iterations=2, sample_id='SAMPLE_ID', batch_size=10000):
    # data = data.copy()
    ...
    # Identify patient populations based on risk
