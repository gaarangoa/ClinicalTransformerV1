...
import logging
import sys
logger = logging.getLogger('SelfSupervisedDataGenerator')
...
class DataGenerator(tf.keras.utils.Sequence):
    ...
    def is_discrete_feature(self, f):
        try: 
            # if it is a discrete feature returns true, however if the value of the discrete feature is nan returns false and ignores the feature
            ...
            # This means it is a continuous feature, if the feature is continuous only return when it is not nan
    ...
    def __data_generation(self, indexes):
        ...
        for ix, ox in enumerate(indexes):
            ...
            # Ignore nan's values in the data
            ...
            np.random.shuffle(vector)
            # 20% random masked input vectors. 
